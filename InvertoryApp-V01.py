...
class StoreManagementApp:
    ...
    def setup_add_product_frame(self):
        ...
        self.company_name = ctk.CTkLabel(self.frame_logo, text="Instrument and Control Department", font=("Arial", 15, "bold"))
        self.company_name.pack(pady=10)
        ...
        self.entry_plant_name_add = ctk.CTkEntry(self.frame_entries_add)
        ...
        self.entry_type_add = ctk.CTkEntry(self.frame_entries_add)
        ...
        self.entry_rack_add = ctk.CTkEntry(self.frame_entries_add)
        self.entry_rack_add.grid(row=4, column=3, padx=5, pady=5)
        ...
        self.entry_description_add.grid(row=5, column=1,padx=5,columnspan=3, pady=5)
        ...
        # ctk.CTkLabel(self.frame_entries_add, text="Description:").grid(row=5, column=0, padx=5, pady=5)
        # self.entry_description_add = ctk.CTkEntry(self.frame_entries_add,height=50,width=400)
        ...
        self.tree_add = ttk.Treeview(self.frame_bottom, columns=("Item No", "Name", "Description", "Plant Name", "Part No", "Quantity"), show="headings")
    ...
    def load_selected_product_add(self, event):
        ...
        self.entry_description_add.delete(0, tk.END)
        self.entry_description_add.insert(0, selected_product["Description"])
        self.entry_plant_name_add.delete(0, tk.END)
        self.entry_plant_name_add.insert(0, selected_product["Plant Name"])
    ...
    def refresh_product_list(self):
        for tree in [self.tree_add, self.tree_withdraw]:
            ...
            for product in self.product_list:
                tree.insert("", "end", values=(product["Item No"], product["Name"], product["Description"], product["Plant Name"], product["Part No"], product["Quantity"]))
